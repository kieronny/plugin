...
REDMINE_FINANCE_REQUIRED_FILES = [
  'redmine_finance/patches/action_controller_patch',
  'redmine_finance/patches/project_patch',
  'redmine_finance/patches/contact_patch',
  'redmine_finance/patches/projects_helper_patch',
  'redmine_finance/patches/notifiable_patch',
  'redmine_finance/patches/queries_helper_patch',
  'redmine_finance/hooks/view_layouts_hook',
  'redmine_finance/hooks/controller_contacts_duplicates_hook',
]

base_url = File.dirname(__FILE__)
REDMINE_FINANCE_REQUIRED_FILES.each { |file| require(base_url + '/' + file) }
